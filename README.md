...
Recent interest in analog and physical reservoir computing suggests that nonlinear materials with intrinsic memory effects may serve as low-power computational substrates.

Magnesium doping may influence defect density, electronic band structure, and phase stability. This work explores whether controlled Mg incorporation (e.g., ~2.8 at.%) can modulate CDW stability and enhance multi-state behavior relevant for analog computation.
...
Mg doping in 1T-TaS₂ modifies phase stability and defect-mediated electronic response, potentially enhancing:
	...
	•	Hysteresis width and controllability
	•	Low-energy state transitions

These properties may support physical-response-based analog computational architectures.
...
Material Preparation
	...
	•	Controlled Mg doping (~2–3 at.%)
	•	Structural verification via XRD

Characterization
	•	STM or TEM for CDW domain observation
	•	Raman spectroscopy for phase confirmation
	•	I–V measurements for nonlinear response
	•	Temperature-dependent transport analysis

Dynamic Testing
	•	Pulse input experiments
	•	Response time measurement
	•	Multi-state switching stability tests
...
If the hypothesis holds, Mg-doped samples should demonstrate:
	...
	•	Enhanced hysteresis controllability
	•	Reduced energy threshold for state switching
	•	Repeatable nonlinear response suitable for signal mapping
...
The hypothesis would be falsified if:
	...
	•	No significant nonlinear enhancement is observed
	•	Energy thresholds remain comparable to undoped samples
	•	Multi-state behavior does not improve
